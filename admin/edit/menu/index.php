...
<body>
  ...
  <main>
    ...
    <div class="container">
      ...
      <input type="text" name="text1" placeholder="Введите пункт 1">
      <input type="text" name="text2" placeholder="Введите пункт 2">
      <input type="text" name="text3" placeholder="Введите пункт 3">
      <input type="text" name="text4" placeholder="Введите пункт 4">
      <h3>Ссылки:</h3>
      <input type="text" name="link1" placeholder="Введите ссылку к пункту 1">
      <input type="text" name="link2" placeholder="Введите ссылку к пункту 2">
      <input type="text" name="link3" placeholder="Введите ссылку к пункту 3">
      <input type="text" name="link4" placeholder="Введите ссылку к пункту 4">
