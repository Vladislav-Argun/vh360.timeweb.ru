...
<body>
      ...
      <li id="dash_users" class="">
        ...
        <div id="dash_users_body" class="collapsible-body" style="display: none;">
          <ul>
            ...
            <li id="users_customer">
              <a class="waves-effect" style="text-decoration: none;" href="../cards-add">Добавить карточки</a>
            </li>
            <li id="users_customer">
  ...
  <main>
    ...
    <div class="container">
      <h2>Добавление карточек</h2>
      <!-- <input type="number" name="id" placeholder="Введите номер картинки"> -->
      <input type="text" name="img" placeholder="Введите путь к картинке">
      <input type="text" name="img_text" placeholder="Введите заголовок к карточке">
      <input type="text" name="img_text2" placeholder="Введите подзаголовок к карточке">
